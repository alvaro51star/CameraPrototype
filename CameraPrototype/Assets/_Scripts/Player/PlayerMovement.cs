...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        m_cc.Move(movement *(m_speed * Time.deltaTime) + upVector);
    }
    ...
    {
        float playerRotation = m_v2_playerRotateInputValue.x * m_rotationSpeedX * Time.deltaTime;
        transform.Rotate(0, playerRotation, 0);
    }

    private void CameraRotation()
    {
        Vector3 cameraRotation = new Vector3(-m_v2_playerRotateInputValue.y , 0, 0) * (m_rotationSpeedY * Time.deltaTime);
